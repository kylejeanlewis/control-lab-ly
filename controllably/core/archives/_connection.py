...
_logger.debug(f"Import: OK <controllably.core.connection>")

logger = logging.getLogger("controllably.core.connection")
logger.setLevel(logging.DEBUG)
handler = logging.StreamHandler()
handler.setLevel(logging.INFO)
handler.addFilter(logging.Filter("controllably.core.connection"+'.'))
