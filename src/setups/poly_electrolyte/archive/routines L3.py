...
LEFT = {
    'arm': dobot_utils_new.VacuumGrip,
    'details': {
        'address': '192.168.2.8',
        # 'home_position': '',
        # 'home_orientation': '',
...
class Setup(object):
    ...
    def decodeSetting(self, setting):
        ...
        setting['arm'] = dobot_utils_new.__dict__[dobot_type]

        details = setting['details']
        setting['details'] = dobot_utils_new.decodeDetails(details)
        return setting
    ...
    def loadSettings(self, filename='dobot_settings L3_old.json', location=there_dobot+'\\settings'):
    ...
    def saveSettings(self, filename='dobot_settings L3_old.json', location=there_dobot+'\\settings'):
        settings = {"left": self.Lobot.getSettings()}
