...
COM_PORT = "COM4"
if 'leongcj' in here:
    SENSORPAL_INSTALLATION = r"C:\Users\leongcj\Desktop\Analog Devices\SensorPal"
else:
    SENSORPAL_INSTALLATION = r"C:\Program Files (x86)\Analog Devices\SensorPal"
...
# Add reference to Sensorpal installation directory
